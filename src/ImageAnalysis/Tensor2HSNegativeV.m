function [imgHSV] = Tensor2HSNegativeV(img,ST,HueThetaZero,HueThetaPi)
% Create an image where ST information is encoded in the HSV space.
% 
%      [imgHSV] = Tensor2HSNegativeV(img,ST,HueThetaZero,HueThetaPi)
%
% Creates an image where tensor orientation encodes Hue, tensor anisotropy
% encodes Saturation and image intensity encodes 1 - Value. 
%
% INPUTS
%
...
%               intensity respectively encode H, S and 1 - V.
%
%
...
% Map Tensor Orientation, Tensor AI and stained as H, S and 1 - V
% channels.
